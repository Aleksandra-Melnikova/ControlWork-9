...
export const selectTransactionShowModal = (state: RootState) =>
  state.transaction.showModal;
export const selectTransactions = (state: RootState) =>
  state.transaction.transactions;
export const selectFetchTransactionLoading = (state: RootState) =>
  state.transaction.isFetchTransactionLoading;
export const selectDeleteTransactionLoading = (state: RootState) =>
  state.transaction.isDeleteLoading;
export const selectOneTransaction = (state: RootState) =>
...
export const { changeTransactionShowModal, changeIsTransactionEdit } =
