...
export const createTransaction = createAsyncThunk<void, ITransactionFormForBase>(
...
export const getOneTransactionById = createAsyncThunk<ITransactionForm | null, string>(
  "transaction/getOneTransactionById  ",
  async (Id) => {
